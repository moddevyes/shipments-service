...
class ShipmentsHandlerTest {
    ...
    void shouldCreate_find_andUpdate_newShipment() {
        ...
        updateShipment.setAccountId(2L);
    ...
    @Test void shouldFindShipment_byId() {
        ...
        assertThat(findByIdShipment.getAccountId()).isEqualTo(initialShipment.getAccountId());
        assertThat(findByIdShipment.getShippingAddressId()).isEqualTo(initialShipment.getShippingAddressId());
